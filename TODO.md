...
_Core features - survival essentials for the first few weeks_
...
## Phase 2 - Sustainability (v0.2)

_Long-term features - add after Phase 1 is stable_

- [ ] p2-1: Add pumping tracking (duration, left/right yields)
- [ ] p2-2: Add health/medications logging
- [ ] p2-3: Add daily summary stats (total sleep, feeding)
- [ ] p2-4: Add timer controls (pause, resume for sleep)

---

## Phase 3 - Polish (v1.0)

_Polish before pediatrician visits_

- [ ] p3-1: Export data to shareable format
- [ ] p3-2: Add growth tracking (weight/height percentiles)
